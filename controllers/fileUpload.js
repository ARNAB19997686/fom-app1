...
exports.imageUpload = async (req, res) => {
    try{
        ...
        console.log("Uploading to arnab_cloud");
        const response = await uploadFileToCloudinary(file, "arnab_cloud");
...
exports.imageSizeReducer = async (req,res) => {
    try{
        ...
        const response = await uploadFileToCloudinary(file, "arnab_cloud", 90);
        console.log(response);
